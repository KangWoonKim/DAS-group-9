...
Firstly, we fitting the logistic regression model since we get binary outcome of obese_yes or obese_no.
Equation containing the explanatory variable and response variable as follows:
...
#| fig-height: 3
#| fig-align: center
plot_model(model_factors, show.values = TRUE, transform = NULL,title = "Log-Odds", show.p=FALSE)
```
